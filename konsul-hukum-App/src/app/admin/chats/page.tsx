          ...
          {chat.messages.map((msg) => (
            <div
              ...
              className={`rounded-2xl p-5 shadow-[0_4px_20px_rgb(0,0,0,0.01)] transition-all duration-300 ${
                msg.role === 'user'
                  ? 'bg-[#1A1A1A] text-white border border-[#1A1A1A] ml-12 shadow-md'
            ...
            >
              <div className="flex items-center gap-2 mb-2 border-b border-white/10 pb-2 last:border-none last:pb-0">
                <span className={`text-[10px] font-bold uppercase tracking-wider ${msg.role === 'user' ? 'text-gray-300' : 'text-blue-600'}`}>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {data?.items.map((chat) => (
                ...
                >
                  <td className="px-5 py-4 text-sm font-semibold text-gray-800 hover:text-blue-600 transition-colors">

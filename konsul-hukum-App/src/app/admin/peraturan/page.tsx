    ...
    <AdminLayout>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold text-white bg-[#1C2544] hover:bg-gray-800 transition-all shadow-md transform hover:-translate-y-0.5 cursor-pointer self-start sm:self-auto"
        >
        ...
        <div className="fixed inset-0 z-50 bg-black/35 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white/95 backdrop-blur-xl border border-white/80 rounded-2xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col custom-scrollbar">
            <div className="flex items-center gap-2 mb-4 border-b border-gray-100 pb-3">
              <BookOpen className="w-5 h-5 text-[#1C2544]" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4 flex-1">
              <div>
                ...
                <Input 
                  ...
                  required 
                  className="rounded-xl border border-gray-200/80 bg-white focus:ring-4 focus:ring-[#D3BA78]/20 focus:border-[#D3BA78]/50 transition-all text-sm h-10 px-3.5"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-gray-200/80 bg-white px-3.5 py-2.5 text-sm min-h-[90px] focus:outline-none focus:ring-4 focus:ring-[#D3BA78]/20 focus:border-[#D3BA78]/50 transition-all custom-scrollbar leading-relaxed"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-100 mt-4">
                ...
                <button 
                  ...
                  className="px-5 py-2 rounded-full text-xs font-semibold bg-[#1C2544] hover:bg-gray-800 text-white transition shadow-sm cursor-pointer disabled:opacity-40"
                >
              ...
              {data?.items.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50/40 transition-colors duration-200">
                  ...
                  <td className="px-5 py-4 text-sm">
                    <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-[#D3BA78]/10 text-[#D3BA78] border border-[#D3BA78]/20">
                      {item.kategori_hukum || '-'}
                    </span>
                  </td>
                  ...
                  <td className="px-5 py-4 text-sm text-center whitespace-nowrap">
                    <button
                      ...
                      className="text-[#D3BA78] hover:text-[#B89E5F] font-semibold hover:underline text-xs cursor-pointer mr-4"
                    >
                      Edit
                    </button>
                    <button

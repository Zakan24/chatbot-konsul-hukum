...
export async function sendOTPEmail(email: string, code: string): Promise<void> {
  ...
  try {
    const { data, error } = await resend.emails.send({
      from: "Konsul Hukum <noreply@konsultasihukum.online>",
      to: [email],
        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <p class="message">
                Halo! Terima kasih telah menggunakan <strong>Konsul Hukum</strong>.
              </p>
              ...
              <div class="footer">
                <p>Email ini dikirim secara otomatis oleh sistem Konsul Hukum.</p>

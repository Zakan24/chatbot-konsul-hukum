 ...
 * Shows: Logo, Tentang Aplikasi, Kontak, Fitur (dropdown), Masuk button.
 */
              ...
              <div className="absolute top-full right-0 mt-2 w-56 rounded-lg border border-border bg-card text-card-foreground shadow-lg py-1 z-50">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Tanya seputar hukum</div>
                  </div>
                </Link>
                <Link
                  href="/direktori"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Jelajahi undang-undang</div>
                  </div>
                </Link>
              </div>
            )}
